      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <p style="color: #666; font-size: 12px; margin-top: 20px;">${t('keepQrCodeSafe')}</p>
          </div>
        </body>
      </html>
    `)
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <img 
              ...
              alt="Esimport Mascot" 
              className="w-16 h-16 mx-auto mb-4 mascot-bounce object-contain"
              onError={(e) => {
                ...
                e.target.onerror = () => {
                  ...
                  fallback.className = 'text-4xl mb-4 mascot-bounce'
