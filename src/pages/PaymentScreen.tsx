...
const PaymentScreen: React.FC = () => {
  ...
  if (loading) return <div className="text-center text-blue-600 py-10">決済処理中...</div>;
  if (error) return <div className="text-center text-red-600 py-10">{error}<button onClick={handlePayment} className="ml-4 px-4 py-2 bg-blue-500 text-white rounded">再試行</button></div>;
